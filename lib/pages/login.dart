...
import 'package:ecomarce/pages/forget_password.dart';
                            ...
                            children: [
                              ...
                              TextFormField(
                                ...
                                decoration: InputDecoration(
                                    hintText: "Email",
                                    hintStyle: SharedWidget.semiBoldtTextStyle(),
                              ...
                              GestureDetector(
                                onTap:()async{
                                  if(formKey.currentState!.validate()){
                                    try {
                                       await FirebaseAuthMetods().logIn(email: email.text, password: password.text, context: context);
